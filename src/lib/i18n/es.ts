...
export const es = {
  ...
  perfil_datos_pareja: 'Datos de la pareja',
  perfil_mis_datos: 'Mis datos',
  perfil_datos_de: (nombre: string) => `Datos de ${nombre}`,
  perfil_pareja_esperando: 'Tu pareja todavía no se vinculó. Compartile el código de invitación.',
  perfil_sin_datos: 'Todavía no hay datos cargados.',
  perfil_cargando_datos: 'Cargando datos...',
  perfil_error_cargar_datos: 'No pudimos cargar los datos de la pareja',
  perfil_reintentar_datos: 'Reintentar',
  perfil_editar_datos: 'Editar mis datos',
  perfil_favoritos: 'Favoritos',
  perfil_color_favorito: 'Color favorito',
  perfil_cancion_favorita: 'Canción favorita',
  perfil_cancion_enlace: 'Enlace de Spotify, YouTube Music o Apple Music',
  perfil_cancion_buscar: 'Buscar datos',
  perfil_cancion_buscando: 'Buscando datos...',
  ...
  perfil_cancion_portada_url: 'URL externa de portada (opcional)',
  perfil_resumen_cancion: 'Resumen y canción',
  perfil_gustos_disgustos: 'Gustos y disgustos',
  perfil_otros: 'Otros',
  perfil_ver_mas: 'Ver más',
  perfil_ver_menos: 'Ver menos',
  perfil_completar_datos: 'Completar datos',
  perfil_buscar_en: (servicio: string) => `Buscar en ${servicio}`,
  perfil_abrir_fuente: 'Abrir fuente original',
  perfil_color_paleta: 'Elegí un color',
  perfil_color_personalizado: 'Color personalizado',
  perfil_color_nombre: 'Nombre del color (opcional)',
  perfil_servicio_preferido: 'Servicio preferido para buscar',
  perfil_sin_preferencia: 'Sin preferencia',
  perfil_cancion_sin_datos: 'Pegá un enlace para completar la canción.',
  perfil_comida_favorita: 'Comida favorita',
  perfil_bebida_favorita: 'Bebida favorita',
  perfil_hobbies: 'Hobbies',
  perfil_gustos: 'Cosas que le gustan',
  perfil_disgustos: 'Cosas que no le gustan',
  perfil_ideas_regalo: 'Ideas de regalos',
  perfil_talles: 'Talles',
  perfil_talle_arriba: 'Parte superior',
  perfil_talle_abajo: 'Parte inferior',
  perfil_talle_zapatos: 'Calzado',
  perfil_talle_abrigo: 'Abrigo',
  perfil_talle_prenda: 'Prenda completa',
  perfil_talle_otro: 'Otro talle',
  perfil_personalizados: 'Datos personalizados',
  perfil_agregar_dato: 'Agregar dato',
  perfil_etiqueta: 'Etiqueta',
  perfil_valor: 'Valor',
  perfil_quitar_dato: 'Quitar dato',
  perfil_guardar_datos: 'Guardar datos',
  perfil_cancelar: 'Cancelar',
  perfil_error_metadata_musica: 'No pudimos leer ese enlace. Podés completar los datos manualmente.',
  perfil_error_guardar_datos: 'No pudimos guardar tus datos',
  perfil_portada_alt: (titulo: string) => `Portada de ${titulo}`,
